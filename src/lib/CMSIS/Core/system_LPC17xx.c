...
#define PCONP_DEFAULT PCONP_PCTIM0_DEFAULT  | PCONP_PCTIM1_DEFAULT | PCONP_PCUART0_DEFAULT | \
                      PCONP_PCUART1_DEFAULT | PCONP_PCPWM1_DEFAULT | PCONP_PCI2C0_DEFAULT  | \
                      PCONP_PCSPI_DEFAULT   | PCONP_PCRTC_DEFAULT  | PCONP_PCSSP1_DEFAULT  | \
                      PCONP_PCADC_DEFAULT   | PCONP_PCCAN1_DEFAULT | PCONP_PCCAN2_DEFAULT  | \
                      PCONP_PCGPIO_DEFAULT  | PCONP_PCRIT_DEFAULT  | PCONP_PCMCPWM_DEFAULT | \
                      PCONP_PCQEI_DEFAULT   | PCONP_PCI2C1_DEFAULT | PCONP_PCSSP0_DEFAULT  | \
                      PCONP_PCTIM2_DEFAULT  | PCONP_PCTIM3_DEFAULT | PCONP_PCUART2_DEFAULT | \
                      PCONP_PCUART3_DEFAULT | PCONP_PCI2C2_DEFAULT | PCONP_PCI2S_DEFAULT   | \
                      PCONP_PCGPDMA_DEFAULT | PCONP_PCENET_DEFAULT | PCONP_PCUSB_DEFAULT
...
#define getM()            ((LPC_SC->PLL0STAT & 0x7FFF) + 1)
#define getN()            (((LPC_SC->PLL0STAT >> 16) & 0xFF) + 1)
#define getCLKSEL()       ((LPC_SC->CCLKCFG & 0xFF)+ 1)
  ...
  if (((LPC_SC->PLL0STAT >> 24) & 3) == 3) { /* If PLL0 enabled and connected */
    switch (LPC_SC->CLKSRCSEL & 0x03) {
      ...
      case 3:                                /* Reserved, default to Int. RC  */
        systemCoreClock = (IRC_OSC * 2 * getM() / getN() / getCLKSEL());
        break;
      case 1:                                /* Main oscillator => PLL0       */
        systemCoreClock = (OSC_CLK * 2 * getM() / getN() / getCLKSEL());
        break;
      case 2:                                /* RTC oscillator => PLL0        */
        systemCoreClock = (RTC_CLK * 2 * getM() / getN() / getCLKSEL());
        break;
    }
  } else {
    switch (LPC_SC->CLKSRCSEL & 0x03) {
      case 0:                                /* Int. RC oscillator => PLL0    */
      case 3:                                /* Reserved, default to Int. RC  */
        systemCoreClock = IRC_OSC / getCLKSEL();
        break;
      case 1:                                /* Main oscillator => PLL0       */
        systemCoreClock = OSC_CLK / getCLKSEL();
        break;
      case 2:                                /* RTC oscillator => PLL0        */
        systemCoreClock = RTC_CLK / getCLKSEL();
        break;
    }
  }
...
#endif
  LPC_SC->PCONP     = PCONP_DEFAULT;        /* Power Control for Peripherals */
